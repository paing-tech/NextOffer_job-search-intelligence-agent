// From AnimateIcons / Lucide (https://animateicons.in)
  ...
  ({ onMouseEnter, onMouseLeave, className, size = 24, duration = 1, isAnimated = true, color, ...props }, ref) => {
    ...
    const curveVariants: Variants = {
      ...
      animate: {
        ...
        opacity: [0.3, 1],
        transition: { duration: 0.6 * duration, delay: 0.3, ease: "easeInOut" },
      },
    };
    ...
    return (
      <LazyMotion features={domMin} strict>
        ...
        >
          ...
          >
            <m.circle cx="12" cy="8" r="5" variants={headVariants} initial="normal" animate={controls} />
            <m.path
