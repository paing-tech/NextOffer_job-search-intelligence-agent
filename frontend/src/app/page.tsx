...
export default function ChatPage() {
  ...
  function send(event: FormEvent) {
    ...
    if (!content) return;
    setMessages((previous) => [...previous, { role: "user", content }, { role: "assistant", content: "This is the local UI preview. I can’t read emails, extract job details, or update Sheets yet. Google sign-in and the agent connection are our next steps. This conversation is temporary and clears when you leave or refresh this page." }]);
    setInput("");
