export default function SettingsPage() {
  return (
    <main className="settings-page">
      <div className="page-heading"><h1>Settings</h1><span className="badge">LOCAL PREVIEW</span></div>
      ...
      <section className="settings-card" aria-labelledby="google-title"><div className="card-title"><h3 id="google-title">01 <span>Google account</span></h3><span className="status">Not connected</span></div><p>Your Google connection will let NextOffer read application emails and update your selected spreadsheet.</p><button className="button primary" disabled>Connect Google</button><small>Google sign-in will be added in the next milestone.</small></section>
      ...
      <p className="settings-footer">This is a setup preview. No credentials or preferences are saved yet.</p>
    </main>
  );
}
